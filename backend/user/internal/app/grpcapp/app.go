...
import (
	"fmt"
	"github.com/Garmonik/gRPC_chat/backend/user/internal/grpc_user"
	userinterfase "github.com/Garmonik/gRPC_chat/backend/user/internal/pkg/interfase_lib"
...
func New(log *slog.Logger, userService userinterfase.User,
	port int, host string) *App {
	gRPCServer := grpc.NewServer()

	grpc_user.RegisterServerAPI(gRPCServer, userService)
	return &App{
		log:        log,
